...
if(isset($_POST['edit_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Tu comentario se editó exitosamente!';
   }
}
...
?>
   ...
   <form action="" method="POST">
      ...
      <div class="inline-option-btn" onclick="window.location.href = 'view_post.php?post_id=<?= $get_id; ?>';">Cancelar edición</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <form action="" method="post" class="add-comment">
      <input type="hidden" name="admin_id" value="<?= $fetch_user_id['user_id']; ?>">
