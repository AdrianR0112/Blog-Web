   ...
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         <form action="" method="POST">
            ...
            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('delete this comment?');">borrar comentario</button>
         </form>
      </div>
      <?php
            }
         }else{
            echo '<p class="empty">No hay comentarios por mostrar!</p>';
         }
      ?>
   </div>
